...
public class FaceDetectorYN {
    ...
    //
    // C++:  void cv::FaceDetectorYNCreated::setInputSize(Size input_size)
    //
    ...
    //
    // C++:  Size cv::FaceDetectorYNCreated::getInputSize()
    //
    ...
    //
    // C++:  void cv::FaceDetectorYNCreated::setScoreThreshold(float score_threshold)
    //
    ...
    //
    // C++:  float cv::FaceDetectorYNCreated::getScoreThreshold()
    //
    ...
    //
    // C++:  void cv::FaceDetectorYNCreated::setNMSThreshold(float nms_threshold)
    //
    ...
    //
    // C++:  float cv::FaceDetectorYNCreated::getNMSThreshold()
    //
    ...
    //
    // C++:  void cv::FaceDetectorYNCreated::setTopK(int top_k)
    //
    ...
    //
    // C++:  int cv::FaceDetectorYNCreated::getTopK()
    //
    ...
    //
    // C++:  int cv::FaceDetectorYNCreated::detect(Mat image, Mat& faces)
    //
    ...
    //
    // C++: static Ptr_FaceDetectorYN cv::FaceDetectorYNCreated::create(String model, String config, Size input_size, float score_threshold = 0.9f, float nms_threshold = 0.3f, int top_k = 5000, int backend_id = 0, int target_id = 0)
    //
