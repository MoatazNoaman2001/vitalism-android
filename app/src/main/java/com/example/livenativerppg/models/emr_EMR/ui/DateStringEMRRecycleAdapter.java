...
public class DateStringEMRRecycleAdapter extends PagingDataAdapter<ImmutablePair<String, ArrayList<ImmutablePair<String, ArrayList<RPPGResult>>>>, DateStringEMRRecycleAdapter.DateStringEMRRecycleViewViewHolder> {
...
//    private Flowable<PagingData<ImmutablePair<String, ArrayList<ImmutablePair<String, ArrayList<RPPGResult>>>>> flowable = Flowable.empty();
    ...
    public DateStringEMRRecycleAdapter(ViewPager2 viewPager2) {
...
class ItemDiffUtils extends DiffUtil.ItemCallback<ImmutablePair<String, ArrayList<ImmutablePair<String, ArrayList<RPPGResult>>>>> {
